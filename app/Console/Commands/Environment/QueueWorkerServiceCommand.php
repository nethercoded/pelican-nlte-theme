...
class QueueWorkerServiceCommand extends Command
{
    ...
    public function handle(): void
    {
        ...
        $serviceName = $this->option('service-name') ?? $this->ask('Queue worker service name', 'nlmanager-queue');
...
After=redis-server.service' : '';
        ...
        $success = File::put($path, "# NLManager Queue File
# ----------------------------------

[Unit]
Description=NLManager Queue Service$afterRedis
