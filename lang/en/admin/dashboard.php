...
return [
    'heading' => 'Welcome to nlmanager.cc',
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'If you run into any issues, please report them on GitHub.',
            'button_label' => 'Create first Node in nlmanager',
        ],
        'intro-support' => [
            'heading' => 'Support nlmanager',
            'content' => 'Thank you for using nlmanager, this could only be achieved through the support of you, our contributors, and the rest of our supporters!',
